...
void BraveAddCommonStrings(content::WebUIDataSource* html_source,
  ...
  webui::LocalizedString localized_strings[] = {
    ...
    {"appearanceSettingsHorizontalTabScaleSubLabel",
     IDS_SETTINGS_APPEARANCE_SETTINGS_HORIZONTAL_TAB_SCALE_SUB_LABEL},
    {"appearanceSettingsVerticalTabScale",
     IDS_SETTINGS_APPEARANCE_SETTINGS_VERTICAL_TAB_SCALE},
    {"appearanceSettingsVerticalTabScaleSubLabel",
     IDS_SETTINGS_APPEARANCE_SETTINGS_VERTICAL_TAB_SCALE_SUB_LABEL},
    {"appearanceSettingsToolbarScale",
     IDS_SETTINGS_APPEARANCE_SETTINGS_TOOLBAR_SCALE},
    {"appearanceSettingsToolbarScaleSubLabel",
     IDS_SETTINGS_APPEARANCE_SETTINGS_TOOLBAR_SCALE_SUB_LABEL},
    {"appearanceSettingsAddressBarScale",
     IDS_SETTINGS_APPEARANCE_SETTINGS_ADDRESS_BAR_SCALE},
    {"appearanceSettingsAddressBarScaleSubLabel",
     IDS_SETTINGS_APPEARANCE_SETTINGS_ADDRESS_BAR_SCALE_SUB_LABEL},
